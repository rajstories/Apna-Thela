...
(async () => {
  ...
  // Seed wallet data (in both development and production)
  const { seedWalletData } = await import("./routes");
  await seedWalletData();
  
  // Seed price comparison data (in both development and production)
